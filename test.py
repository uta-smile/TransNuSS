...
def inference(args, model, test_save_path=None):
    db_test = Zenodo_dataset(data_path="data", split="test") #args.Dataset(base_dir=args.volume_path, split="test_vol", list_dir=args.list_dir)
